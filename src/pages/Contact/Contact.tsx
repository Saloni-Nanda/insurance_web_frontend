...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/mldwllpa", {
        method: "POST",
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-3 py-2 border rounded-lg text-sm bg-gray-50/50 hover:bg-white ${
                          errors.fullName
                            ? "border-red-500"
                  ...
                  <div className="relative">
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        onChange={handleInputChange}
                        rows={3}
                        className={`w-full pl-10 pr-3 py-2 border rounded-lg text-sm bg-gray-50/50 hover:bg-white resize-none ${
                          errors.message
                            ? "border-red-500"
                            : "border-[#1B2951]/20 focus:border-[#B99D54] focus:ring-2 focus:ring-[#B99D54]/20"
                        }`}
                  ...
                  <div className="text-center pt-1">
                    <button
                      ...
                      className={`inline-flex items-center justify-center px-4 py-2 text-sm font-semibold text-white rounded-lg transition-all min-w-32 ${
                        isSubmitting
...
//     <>
//       <Helmet>
//         <title>Contact RBG HR Services LLP | Insurance Recruitment Experts</title>
//         <meta
//           name="description"
//           content="Looking to hire for your insurance business? Contact
//           RBG HR Services LLP today. Fast closures, pan-India delivery, and
//           leadership hiring at 10% of standard cost."
//         />
//       </Helmet>
...
//             <div className="lg:col-span-1">
//               <div className="relative bg-gradient-to-br from-[#1B2951] to-[#2a3f6b] rounded-xl p-6 text-center h-full flex flex-col justify-center shadow-md">
...
//                     href="https://www.linkedin.com/company/rbg-hr-services-llp/?viewAsMember=true"
//                     target="_blank"
//                     className="group relative w-12 h-12 bg-white/10 border border-[#B99D54]/50 rounded-full flex items-center justify-center text-white transition-all duration-300 hover:bg-[#B99D54] hover:scale-110 hover:shadow-lg hover:shadow-[#B99D54]/30"
//                     aria-label="LinkedIn"
//                   >
